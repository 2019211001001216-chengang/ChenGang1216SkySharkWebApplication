          ...
          <div class="tabContents">
            <table>
                ...
                <tr>
                    ...
                    <td>text2<asp:DropDownList ID="DropDownList2" runat="server"></asp:DropDownList></td>
                    <td>text3<asp:Button ID="Button1" runat="server" Text="Button" /></td>
                </tr>
                <tr>
                    <td>text1<asp:DropDownList ID="DropDownList3" runat="server"></asp:DropDownList></td>
                    <td>text2<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></td>
                    <td>text3<asp:Button ID="Button2" runat="server" Text="Button" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
